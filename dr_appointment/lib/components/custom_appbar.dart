...
class CustomAppBar extends StatefulWidget implements PreferredSizeWidget {
  const CustomAppBar({super.key,this.appTitle,this.actions,this.icon,this.route});

  @override
  Size get preferredSize => const Size.fromHeight(60); // default height of appbar
      ...
      leading: widget.icon != null ? Container(
        ...
        child: IconButton(onPressed: (){
          ...
          if (widget.route!=null){
            ...
            // else simply pop back previous page 
